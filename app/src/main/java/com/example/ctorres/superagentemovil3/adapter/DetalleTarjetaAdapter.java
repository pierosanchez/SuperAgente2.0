...
public class DetalleTarjetaAdapter extends BaseAdapter {

    ArrayList<UsuarioEntity> items;
    Context context;
    LayoutInflater layoutInflater = null;

    public DetalleTarjetaAdapter(ArrayList<UsuarioEntity> items, Context context) {
        this.items = items;
    ...
    public void setNewListTarjetaBin(ArrayList<UsuarioEntity> listUsuarioReniec){
