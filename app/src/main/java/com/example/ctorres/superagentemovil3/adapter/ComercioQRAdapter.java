...
public class ComercioQRAdapter extends BaseAdapter {

    ArrayList<ComercioEntity> items;
    Context context;
    LayoutInflater layoutInflater = null;

    public ComercioQRAdapter(ArrayList<ComercioEntity> items, Context context) {
        this.items = items;
    ...
    public void setNewListDetalleComercio(ArrayList<ComercioEntity> listBeneficiario){
